    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6 mt-2 mb-4">
            <h2 class="my-4 footer-brand"><span class="font-weight-bold">Deluxe</span>Resort</h2>
            <p
              class="mb-4"
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-2 mb-4">
            <h5 class="my-4 font-weight-bold text-center">ABOUT US</h5>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-2 mb-4">
            <h5 class="my-4 font-weight-bold text-center">LATEST UPDATES</h5>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 mt-2 mb-4">
            <h5 class="my-4 font-weight-bold">NEWSLETTER</h5>
      ...
      <div class="copyright">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <div class="text-center text-white">&copy; 2019 Your Company. All Rights Reserved.</div>
            </div>
          </div>
        </div>
      </div>
